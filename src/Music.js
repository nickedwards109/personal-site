  ...
  render () {
    return (
      <div>
        ...
        <p>Here is a traditional Irish tune called "The Green Fields of America". I love this tune's aspirational and celebratory mood. One can imagine the emigrant's hope for a better future, perhaps far across the sea in a distant land. This recording features the Fiddle and the Anglo Concertina.</p>
        <audio controls>
